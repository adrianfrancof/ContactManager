...
_Proyecto que permite desplegar el control para la creación, modificacion, eliminación de contactos realizando persistencia de datos, respondiendo a las peticiones (request) a traves del controlador utilizando

* jsp, spring web, oracle driver, lombok
_
